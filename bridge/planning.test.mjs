...
test('wrong profile and frame size fail',()=>{const f=fixture();f.s.noteProfile='default';reject(f,/noteProfile/);f.s.noteProfile='android-review';f.s.pages[0].widgets[0].width=390;reject(f,/Android frame/);});
