...
export async function beginRun(out,{mode,model,plan,scene,planning}){
 ...
 const start={runId,bundleVersion:'1.6.0',mode,startedAt:new Date().toISOString(),previousInputRunId:previous,inputHash:digest(inputs),changes:changes(before?.model,model),planningStage:planning.stage,status:planning.ok===false?'planning-blocked':'started',scriptTimingOnly:true};
